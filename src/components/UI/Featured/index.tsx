...
import big_banner from '../../../../public/images/banner.jpg';
import featured_mobile_banner from '../../../../public/images/help_banner.jpg';
        ...
        <ImageContainer>
          ...
          >
            {isMobile ? (
              ...
              <Image src={big_banner} alt="big_banner" fill style={{ objectFit: 'contain' } }/>
            )}
          </Div>
        </ImageContainer>
